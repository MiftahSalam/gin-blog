...
var MockDeleteArticle = []RouterMockTest{
	{
		UserMockTest: userServices.MockTests{
			TestName: "error unauthorized (no token present): DeleteArticle Test",
